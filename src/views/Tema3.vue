  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9
        ...
        .row.pe-lg-4.row.justify-content-center.align-items-center
          .col-auto.pe-2
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 <b>Proteínas:</b> 4 gramos. Entonces se multiplica (4 g x 4 kcal/g) = 16 kcal
        .row.pe-lg-4.row.justify-content-center.align-items-center
          .col-auto.pe-2
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 <b>Grasas:</b>12 gramos. Entonces se multiplica (12 g x 9 kcal/g) = 108 kcal                  
        .row.pe-lg-4.row.justify-content-center.align-items-center
          .col-auto.pe-2
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 <b>Glúcidos:</b>19 gramos. Entonces se multiplica (19 gr x 4 kcal/g) = 76 kcal              
        .row.pe-lg-4.row.justify-content-center.align-items-center.mb-4
          .col-auto.pe-2
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9
        ...
        .row.pe-lg-4.row.justify-content-center.align-items-center
          .col-auto.pe-2
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-4 <b>Edad:</b>Entre más joven, el metabolismo basal es más alto, esto se debe al crecimiento. 
      ...
      .col-lg-10
          ...
          p.mb-4 A este cálculo se le añade un factor de corrección en función del ejercicio físico realizado:

          .titulo-sexto.color-acento-contenido
            h5 Tabla 7.
            span Función del ejercico fícico realizado

          p Poco o ninguno ejercicio	Calorías diarias necesarias= TMB x 1,2
          p Ejercicio ligero (1-3 días a la semana, ejercicios de baja intensidad).	Calorías diarias necesarias= TMB x 1,375
          P Ejercicio ligero (3-5 días a la semana, ejercicios de baja intensidad).	Calorías diarias necesarias= TMB x 1,55
          p Ejercicio ligero (6-7 días a la semana, ejercicios de baja intensidad).	Calorías diarias necesarias= TMB x 1,725

          .tabla-b.color-acento-contenido.mb-5.tbl
            table
              caption Nota. UNED (2017)

          p Este concepto tiene que ver con la temperatura del medio ambiente, puesto que cuando una persona se encuentra a un ambiente a temperatura media de trópico, el metabolismo basal disminuye en un 10%, mientras que en climas con temperaturas altas el metabolismo basal puede bajar un 10% en relación con los lugares de clima frío.    
    ...
    .row.mb-4.pe-lg-3.align-items-center(data-aos="fade-left")
      ...
      .col-auto.px-0
        h3.mb-0 Actividad física

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9
        .row
          .col-auto.mb-3
            p Este factor está representado por la energía que se gasta en el ejercicio físico voluntario y los movimientos que se realizan en las actividades diarias. Si se desarrolla alguna actividad física, las necesidades energéticas aumentan, en situaciones extremas puede alcanzar hasta cincuenta veces la consumida en reposo.

            h3.mb-0.fnd-2-1.fnd-2 Actividades relacionadas con cada nivel de la actividad:
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-3
        figure
          img(src='@/assets/curso/temas/tema3/img-8.png', alt='') 
    ...
    p.mb-5 A continuación, se exponen las ecuaciones para calcular el gasto energético en reposo, elaboradas por expertos de la Organización de las Naciones Unidas para la Alimentación y la Agricultura, la Universidad de las Naciones Unidas y la Organización Mundial de la Salud:

    p Para calcular el gasto energético en reposo se puede utilizar el método de la Organización de las Naciones Unidas para la Alimentación y la Agricultura (FAO), la Organización Mundial de la Salud (OMS) y la Universidad de las Naciones Unidas (UNU): 1. Se calcula el gasto energético en reposo (GER) con las ecuaciones de la FAO,OMS y UNU. En esta ecuación se incluye el efecto térmico de los alimentos. 2. El gasto energético en reposo (GER) se multiplica por la constante del factor de actividad física.
